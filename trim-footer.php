		...
		<p id="copyright"><?php printf( __('Designed by %s | Copyright Live the Passion 2013'), '<a href="http://www.chapmanstudios.com.au" title="Online and social media consulting">Chapman Studios</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
	</div> <!-- end #container -->
